...
public enum Proteus_GroupInfoType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Proteus_GroupInfoType: CaseIterable {
  // Support synthesized by the compiler.
}

#endif  // swift(>=4.2)

public enum Proteus_RatchetTreeType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case full // = 1
  case delta // = 2
  case reference // = 3
...
extension Proteus_RatchetTreeType: CaseIterable {
  // Support synthesized by the compiler.
}
...
public struct Proteus_GroupInfoBundle {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var groupInfoType: Proteus_GroupInfoType {
  ...
  public var ratchetTreeType: Proteus_RatchetTreeType {
  ...
  fileprivate var _groupInfoType: Proteus_GroupInfoType? = nil
  fileprivate var _ratchetTreeType: Proteus_RatchetTreeType? = nil
  fileprivate var _groupInfo: Data? = nil
}

public struct Proteus_CommitBundle {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var groupInfoBundle: Proteus_GroupInfoBundle {
    get {return _groupInfoBundle ?? Proteus_GroupInfoBundle()}
  ...
  fileprivate var _groupInfoBundle: Proteus_GroupInfoBundle? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Proteus_Priority: @unchecked Sendable {}
extension Proteus_GroupInfoType: @unchecked Sendable {}
extension Proteus_RatchetTreeType: @unchecked Sendable {}
...
extension Proteus_GroupInfoBundle: @unchecked Sendable {}
extension Proteus_CommitBundle: @unchecked Sendable {}
...
extension Proteus_GroupInfoType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Proteus_RatchetTreeType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "FULL"),
    2: .same(proto: "DELTA"),
...
extension Proteus_GroupInfoBundle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Proteus_GroupInfoBundle, rhs: Proteus_GroupInfoBundle) -> Bool {
...
extension Proteus_CommitBundle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Proteus_CommitBundle, rhs: Proteus_CommitBundle) -> Bool {
